...
export default function HomePage() {
  return (
    <div style={{ background: "var(--paper)", color: "var(--ink)", minHeight: "100vh" }}>
      ...
      {/* Hero */}
      <section className="py-16 lg:py-28 relative overflow-hidden" style={{
        ...
        <div className="max-w-5xl mx-auto px-4 lg:px-6">
          ...
          {/* 問題3: 数値表示 — スマホで gap を縮小、フォントサイズ調整 */}
          <div className="flex items-center gap-5 lg:gap-8">
            {[
              ...
              <div key={i} className="flex items-center gap-5 lg:gap-8">
                ...
                <div>
                  <div className="font-display text-2xl lg:text-3xl font-light whitespace-nowrap">{num}</div>
                  <div className="text-[10px] lg:text-[11px] tracking-wider uppercase mt-1" style={{ color: "var(--ink-soft)" }}>{label}</div>
                </div>
              </div>
            ))}
          </div>
      ...
      {/* Features */}
      <section className="py-16 lg:py-24 border-t" style={{ borderColor: "rgba(26,26,46,0.06)", background: "var(--paper-warm)" }}>
        <div className="max-w-5xl mx-auto px-4 lg:px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-5">
            {[
              ...
              <Link key={f.title} href={f.href}>
                <div className="card p-6 lg:p-7 h-full cursor-pointer transition-shadow hover:shadow-md">
                  <div className="text-4xl mb-4 lg:mb-5">{f.icon}</div>
